...
type RedisMemoryInfo struct {
	...
	UnixEpoch                  uint64  `protobuf:"varint,52,opt,name=unix_epoch,json=unixEpoch,proto3" json:"unix_epoch,omitempty"`
}
...
func (x *RedisMemoryInfo) GetUnixEpoch() uint64 {
	if x != nil {
		return x.UnixEpoch
	}
	return 0
...
var file_info_memory_proto_rawDesc = []byte{
	...
	0x22, 0xf6, 0x13, 0x0a, 0x0f, 0x52, 0x65, 0x64, 0x69, 0x73, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79,
	...
	0x65, 0x65, 0x64, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x75, 0x6e,
	0x69, 0x78, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x18, 0x34, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09,
...
var file_info_memory_proto_goTypes = []interface{}{
	(*RedisMemoryInfo)(nil), // 0: agent.redis.RedisMemoryInfo
}
